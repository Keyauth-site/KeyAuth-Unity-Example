...
namespace EpicAuth
{
    public class api : MonoBehaviour
    {
        ...
        {
            UnityEngine.Debug.LogError("Application is not setup correctly. Please make sure you entered the correct application name, secret, ownerID and version and try again.");
        ...
        {
            UnityEngine.Debug.LogError("Application was not found. Please check your application information.");
            yield return new WaitForSeconds(3);
            Application.Quit();
        }
        ...
        private static string req(NameValueCollection post_data)
        {
            try
            {
                ...
                {
                    var raw_response = client.UploadValues("https://keyauth.site/api/1.0/", post_data);
        ...
        private static string req_unenc(NameValueCollection post_data)
        {
            try
            {
                using (WebClient client = new WebClient())
                {
                    var raw_response = client.UploadValues("https://keyauth.site/api/1.1/", post_data);
    ...
    public static class encryption
    {
        ...
        public static byte[] str_to_byte_arr(string hex)
        {
            ...
            {
                UnityEngine.Debug.LogError("Session has ended. Please reconnect.");
                Application.Quit();
                return null;
            }
        }
